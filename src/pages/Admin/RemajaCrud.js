...
function RemajaCrud() {
  ...
  const handleCreate = async () => {
    ...
    try {
      const response = await axios.post('http://localhost:8080/remaja', newData);
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await axios.put(`http://localhost:8080/remaja/${editId}`, newData);
  ...
  const handleDelete = async (id) => {
    ...
    try {
        const response = await axios.delete(`http://localhost:8080/remaja/delete/${id}`);
