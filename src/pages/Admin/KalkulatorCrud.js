...
function KalkulatorCrud() {
  ...
  const handleCreate = async () => {
    ...
    try {
      const response = await axios.post('http://localhost:8080/kalkulator_gizi/calculate', newData);
...
const handleUpdate = async () => {
    ...
    try {
        const response = await axios.put(`http://localhost:8080/kalkulator_gizi/${editId}`, newData);
        setData((prevData) => 
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`http://localhost:8080/kalkulator_gizi/delete/${id}`);
