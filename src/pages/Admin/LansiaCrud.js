...
function LansiaCrud() {
  ...
  const handleCreate = async () => {
    ...
    try {
      const response = await axios.post('http://localhost:8080/lansia', newData);
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await axios.put(`http://localhost:8080/lansia/${editId}`, newData);
  ...
  const handleDelete = async (id) => {
    ...
    try {
        const response = await axios.delete(`http://localhost:8080/lansia/delete/${id}`);
